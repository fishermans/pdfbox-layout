...
public class WordBreakers {
	...
	public static class NonBreakingWordBreaker implements WordBreaker {
		...
		@Override
		public Pair<String> breakWord(String word, FontDescriptor fontDescriptor, float maxWidth,
	...
	/**
	 * Abstract base class for implementing (custom) word breakers. Tries to break
	 * the word {@link #breakWordSoft(String, FontDescriptor, float) softly}, or -
	...
	public static abstract class AbstractWordBreaker implements WordBreaker {
		...
		@Override
		public Pair<String> breakWord(final String word, final FontDescriptor fontDescriptor, final float maxWidth,
		...
		/**
		 * To be implemented by subclasses. Give your best to break the word softly
		 * using your strategy, otherwise return <code>null</code>.
		 * 
		 ...
		 */
		abstract protected Pair<String> breakWordSoft(final String word, final FontDescriptor fontDescriptor,
		 ...
		 * @throws IOException by pdfbox
		 */
		protected Pair<String> breakWordHard(final String word, final FontDescriptor fontDescriptor,
				final float maxWidth) throws IOException {
	...
	/**
	 * Breaks a word if one of the following characters is found after a non-digit
	 * letter:
	 * <ul>
	 * <li>.</li>
	 * <li>,</li>
	...
	public static class DefaultWordBreaker extends AbstractWordBreaker {
		...
		/**
		 * A letter followed by either <code>-</code>, <code>.</code>, <code>,</code> or
		 * <code>/</code>.
		 */
		...
		@Override
		protected Pair<String> breakWordSoft(final String word, final FontDescriptor fontDescriptor,
				final float maxWidth) throws IOException {
