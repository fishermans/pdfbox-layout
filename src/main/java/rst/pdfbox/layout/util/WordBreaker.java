...
public interface WordBreaker {
	 ...
	 * @param breakHardIfNecessary indicates if the word should be broken hard to
	 *                             fit the width, in case there is no suitable
	 *                             position for breaking it adequately.
	 * @return the broken word, or <code>null</code> if it cannot be broken.
	 * @throws IOException by pdfbox
	 */
	Pair<String> breakWord(final String word, final FontDescriptor fontDescriptor, final float maxWidth,
