...
public class PageFormat implements Element {
	 ...
	 */
	public PageFormat(PDRectangle mediaBox, Orientation orientation, float marginLeft, float marginRight,
	 ...
	 * @param marginBottom the bottom margin
	 */
	public PageFormat(PDRectangle mediaBox, Orientation orientation, int rotation, float marginLeft, float marginRight,
			float marginTop, float marginBottom) {
