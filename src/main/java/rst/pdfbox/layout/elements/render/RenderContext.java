...
public class RenderContext implements Renderer, Closeable, DrawContext, DrawListener {
	...
	/**
	 * @return the current rendering position in pdf coord space (origin in lower
	 *         left corner).
	 */
	...
	/**
	 * Moves the {@link #getCurrentPosition() current position} relatively by the
	 * given offset.
	 * 
	...
	/**
	 * @return the maximum right and bottom position of all objects rendered on this
	 *         page so far.
	 */
