...
public class VerticalLayoutHint implements LayoutHint {
	 ...
	 */
	public VerticalLayoutHint(Alignment alignment, float marginLeft, float marginRight, float marginTop,
			float marginBottom) {
	 ...
	 * @param marginTop    the top alignment.
	 * @param marginBottom the bottom alignment.
	 * @param resetY       if <code>true</code>, the y coordinate will be reset to
	 *                     the point before layouting the element.
	 */
	public VerticalLayoutHint(Alignment alignment, float marginLeft, float marginRight, float marginTop,
			float marginBottom, boolean resetY) {
	...
	public String toString() {
		return "VerticalLayoutHint [alignment=" + alignment + ", marginLeft=" + marginLeft + ", marginRight="
				+ marginRight + ", marginTop=" + marginTop + ", marginBottom=" + marginBottom + ", resetY=" + resetY
				+ "]";
	}
	...
	public static class VerticalLayoutHintBuilder {
		...
		public VerticalLayoutHintBuilder margins(float marginLeft, float marginRight, float marginTop,
				float marginBottom) {
			this.marginLeft = marginLeft;
			this.marginRight = marginRight;
			this.marginTop = marginTop;
