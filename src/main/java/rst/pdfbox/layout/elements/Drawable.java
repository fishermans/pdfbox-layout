...
public interface Drawable {
	...
	/**
	 * If an absolute position is given, the drawable will be drawn at this position
	 * ignoring any {@link Layout}.
	 * 
	 ...
	 * @throws IOException by pdfbox
	 */
	void draw(PDDocument pdDocument, PDPageContentStream contentStream, Position upperLeft, DrawListener drawListener)
			throws IOException;
