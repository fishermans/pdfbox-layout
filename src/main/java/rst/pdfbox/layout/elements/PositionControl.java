...
public class PositionControl extends ControlElement {
	...
	/**
	 * Use this value in {@link #createSetPosition(Float, Float)} to reset either
	 * one or both coordinates to the marked position.
	 */
	...
	/**
	 * Add this element to a document to manipulate the current layout position. If
	 * <code>null</code>, the position won't be changed (useful if you want to
	 * change only X or Y). If the value is {@link #MARKED_POSITION}, it wil be
	 * (re-)set to the marked position.
	 * 
	 * @param newX the new X position.
	 * @param newY new new Y position.
	 * @return the created element
	 */
	public static SetPosition createSetPosition(final Float newX, final Float newY) {
		return new SetPosition(newX, newY);
	}

	/**
	 * Add this element to a document to manipulate the current layout position by a
	 * relative amount. If <code>null</code>, the position won't be changed (useful
	 * if you want to change only X or Y).
	 * 
	 * @param relativeX the value to change position in X direction.
	 * @param relativeY the value to change position in Y direction.
	 * @return the created element
	 */
	public static MovePosition createMovePosition(final float relativeX, final float relativeY) {
