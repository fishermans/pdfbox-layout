...
public interface Dividable {
	...
	/**
	 * Divides the drawable vetically into pieces where the first part is to respect
	 * the given remaining height. The page height allows to make better decisions
	 * on how to divide best.
	 * 
	 * @param remainingHeight the remaining height on the page dictating the height
	 *                        of the first part.
	 * @param nextPageHeight  the height of the next page allows to make better
	 *                        decisions on how to divide best, e.g. maybe the
	 *                        element fits completely on the next page.
