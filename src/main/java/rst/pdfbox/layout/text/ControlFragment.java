...
public class ControlFragment implements TextFragment {
	...
	protected final static FontDescriptor DEFAULT_FONT_DESCRIPTOR = new FontDescriptor(BaseFont.Helvetica.getPlainFont(), 11);
	...
	protected ControlFragment(final String name, final String text, final FontDescriptor fontDescriptor,
			final Color color) {
		this.name = name;
		if (this.name == null) {
