...
public class AnnotatedStyledText extends StyledText implements Annotated {
	 ...
	 */
	public AnnotatedStyledText(final String text, final FontDescriptor fontDescriptor, final Color color,
			final float leftMargin, final float rightMargin, final float baselineOffset,
	 ...
	 * @param annotations    the annotations associated with the text.
	 */
	public AnnotatedStyledText(String text, float size, PDFont font, Color color, final float baselineOffset,
			Collection<? extends Annotation> annotations) {
	...
	public AnnotatedStyledText inheritAttributes(String text, float leftMargin, float rightMargin) {
		return new AnnotatedStyledText(text, getFontDescriptor(), getColor(), getBaselineOffset(), leftMargin,
				rightMargin, annotations);
	}
}
