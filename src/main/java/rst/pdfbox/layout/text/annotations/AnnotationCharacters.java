...
public class AnnotationCharacters {
	...
	private static class HyperlinkControlCharacterFactory
		...
		@Override
		public HyperlinkControlCharacter createControlCharacter(String text, Matcher matcher,
	...
	private static class AnchorControlCharacterFactory
		...
		@Override
		public AnchorControlCharacter createControlCharacter(String text, Matcher matcher,
				final List<CharSequence> charactersSoFar) {
	...
	private static class UnderlineControlCharacterFactory
		...
		@Override
		public UnderlineControlCharacter createControlCharacter(String text, Matcher matcher,
				final List<CharSequence> charactersSoFar) {
	 ...
	 * (not starting with <code>#</code> will be treated as an external link. It can
		...
		private static float getdefaultBaselineOffsetScale() {
			if (defaultBaselineOffsetScale == null) {
				defaultBaselineOffsetScale = Float
						.parseFloat(System.getProperty(UNDERLINE_DEFAULT_BASELINE_OFFSET_SCALE_PROPERTY, "-0.1"));
			}
