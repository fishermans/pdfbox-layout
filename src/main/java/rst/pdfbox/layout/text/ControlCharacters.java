...
public class ControlCharacters {
	...
	/**
	 * A control character factory is used to create control characters on the fly
	 * from the control pattern. This allows to parameterize the characters as
	 * needed for e.g. colors.
	 */
	public static interface ControlCharacterFactory {
		 ...
		 */
		ControlCharacter createControlCharacter(final String text, final Matcher matcher,
		 ...
		 * 
		 * @return <code>true</code> if the pattern is to be applied at the begin of a
		 *         line.
		 */
	 ...
	 */
	public static ControlCharacterFactory BOLD_FACTORY = new StaticControlCharacterFactory(new BoldControlCharacter(),
	...
	/**
	 * An asterisk ('*') indicates switching of bold font mode in markup. It can be
	...
	public static class MetricsControlCharacter extends ControlCharacter {
		...
		protected MetricsControlCharacter(String name, final String fontScale, final String baselineOffset) {
	...
	private static class MetricsControlCharacterFactory implements ControlCharacterFactory {
