...
public class StyledText implements TextFragment {
	 ...
	 */
	public StyledText(final String text, final FontDescriptor fontDescriptor, final Color color,
			final float baselineOffset, final float leftMargin, final float rightMargin) {
		if (text.contains("\n")) {
	...
	public String toString() {
		return "StyledText [text=" + text + ", fontDescriptor=" + fontDescriptor + ", width=" + width + ", color="
				+ color + ", leftMargin=" + leftMargin + ", rightMargin=" + rightMargin + ", baselineOffset="
				+ baselineOffset + "]";
	}
