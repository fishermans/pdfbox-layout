...
public class Indent extends ControlFragment {
	...
	/**
	 * Creates a new line with the {@link ControlFragment#DEFAULT_FONT_DESCRIPTOR}'s
	 * font and the given height.
	 * 
	 ...
	 * @throws IOException by pdfbox
	 */
	public Indent(final String label, final float indentWidth, final SpaceUnit indentUnit, final float fontSize,
	 ...
	 */
	public Indent(final String label, final float indentWidth, final SpaceUnit indentUnit, final float fontSize,
			final PDFont font, final Alignment alignment, final Color color) throws IOException {
	 ...
	 * @throws IOException by pdfbox
	 */
	public Indent(final String label, final float indentWidth, final SpaceUnit indentUnit,
			final FontDescriptor fontDescriptor, final Alignment alignment, final Color color) throws IOException {
		...
		styledText = new StyledText(label, getFontDescriptor(), getColor(), 0, marginLeft, marginRight);
	}
	...
	private float calculateIndent(final float indentWidth, final SpaceUnit indentUnit,
