...
public class Stroke {
	...
	/**
	 * Describes a PDF dash pattern. See the PDF documentation for more information
	 * on that.
	 */
	public static class DashPattern {
		...
		/**
		 * Creates a pattern with different on and off length, starting with the given
		 * phase .
		 * 
		 * @param on    the length of the off part.
		 * @param off   the length of the off part.
	...
	/**
	 * Creates a Stroke with line width 1, cap style {@link CapStyle#Cap}, join
	 * style {@link JoinStyle#Miter}, and no dash pattern.
	 */
	public Stroke() {
		this(1f);
	}
	...
	/**
	 * Creates a Stroke with the given line width, cap style {@link CapStyle#Cap},
	 * join style {@link JoinStyle#Miter}, and no dash pattern.
	 * 
