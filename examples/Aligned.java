...
public class Aligned {
	...
	paragraph.addText("This is some left aligned text", 11, BaseFont.Helvetica.getPlainFont());
	paragraph.setAlignment(Alignment.Left);
	paragraph.setMaxWidth(40);
	document.add(paragraph, VerticalLayoutHint.LEFT);

	paragraph = new Paragraph();
	paragraph.addText("This is some centered text", 11, BaseFont.Helvetica.getPlainFont());
	paragraph.setAlignment(Alignment.Center);
	paragraph.setMaxWidth(40);
	document.add(paragraph, VerticalLayoutHint.CENTER);

	paragraph = new Paragraph();
	paragraph.addText("This is some right aligned text", 11, BaseFont.Helvetica.getPlainFont());
	paragraph.setAlignment(Alignment.Right);
	paragraph.setMaxWidth(40);
	document.add(paragraph, VerticalLayoutHint.RIGHT);

	paragraph = new Paragraph();
	paragraph.addText("Text is right aligned, and paragraph centered", 11, BaseFont.Helvetica.getPlainFont());
	paragraph.setAlignment(Alignment.Right);
	paragraph.setMaxWidth(40);
	document.add(paragraph, VerticalLayoutHint.CENTER);
