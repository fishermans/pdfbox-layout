...
public class Indentation {
	...
	paragraph
		.addMarkup(
			...
			11, BaseFont.Times);
	paragraph.add(new Indent("This is some label", 100, SpaceUnit.pt, 11, BaseFont.Times.getBoldFont()));
	paragraph.addMarkup("Here we go indented.\n", 11, BaseFont.Times);
	paragraph
		.addMarkup(
	...
	paragraph.add(new Indent(new ArabicEnumerator().next() + " ", 4,
		SpaceUnit.em, 11, BaseFont.Times.getBoldFont(), Alignment.Right));
	...
	paragraph.add(new Indent(new LowerCaseRomanEnumerator().next() + " ",
		4, SpaceUnit.em, 11, BaseFont.Times.getBoldFont(), Alignment.Right));
	...
	paragraph.add(new Indent(new LowerCaseAlphabeticEnumerator().next()
		+ " ", 4, SpaceUnit.em, 11, BaseFont.Times.getBoldFont(),
		Alignment.Right));
